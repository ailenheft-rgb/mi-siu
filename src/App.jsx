...
const UAP_CALENDAR_2026 = [
  ...
  { date: '2026-03-23', title: 'Día no laborable', type: 'Feriado' },
  { date: '2026-03-24', title: 'Día de la Memoria', type: 'Feriado' },
  { date: '2026-04-02', title: 'Veterano y Caídos / Jueves Santo', type: 'Feriado' },
  ...
  { date: '2026-10-12', title: 'Diversidad Cultural', type: 'Feriado' },
  { date: '2026-11-23', title: 'Soberanía Nacional', type: 'Feriado' },
  { date: '2026-12-07', title: 'Día no laborable', type: 'Feriado' },
  ...
  { date: '2026-03-09', title: 'Inicio 1er Cuatrimestre', type: 'Institucional' },
  { date: '2026-03-10', title: 'Acto formal inicio de clases', type: 'Institucional' },
  ...
  { date: '2026-05-22', title: 'XVI Simposio Teológico', type: 'Institucional' },
  { date: '2026-05-23', title: 'XVI Simposio Teológico', type: 'Institucional' },
  { date: '2026-05-24', title: 'XVI Simposio Teológico', type: 'Institucional' },
  ...
  { date: '2026-08-03', title: 'Inicio 2do Cuatrimestre', type: 'Institucional' },
  { date: '2026-08-08', title: '2º Homecoming', type: 'Institucional' },
  { date: '2026-08-21', title: 'I Will Go UA/UAP', type: 'Institucional' },
  { date: '2026-08-22', title: 'I Will Go UA/UAP', type: 'Institucional' },
  { date: '2026-09-02', title: 'Congreso de Fe y Ciencia', type: 'Institucional' },
  { date: '2026-09-03', title: 'Congreso de Fe y Ciencia', type: 'Institucional' },
  { date: '2026-09-04', title: 'Congreso de Fe y Ciencia', type: 'Institucional' },
  { date: '2026-09-05', title: 'Congreso de Fe y Ciencia', type: 'Institucional' },
  ...
  { date: '2026-02-23', title: 'Matrícula Web Ingresantes', type: 'Tramite' },
  { date: '2026-03-16', title: 'Último día solicitar Graduación', type: 'Tramite' },
  { date: '2026-03-31', title: 'Último día matriculación', type: 'Tramite' },
  { date: '2026-05-29', title: 'Último día abandono asig. cuat.', type: 'Tramite' },
  { date: '2026-07-17', title: 'Inicio Matrícula Web (2do Cuat.)', type: 'Tramite' },
  { date: '2026-08-20', title: 'Último día solicitar Graduación', type: 'Tramite' },
  { date: '2026-08-31', title: 'Último día matriculación', type: 'Tramite' },
  { date: '2026-09-04', title: 'Último día abandono asig. anuales', type: 'Tramite' },
  { date: '2026-10-30', title: 'Último día abandono asig. cuat.', type: 'Tramite' },
  { date: '2026-11-24', title: 'Inicio inscrip. online a exámenes', type: 'Tramite' },

  // EVENTOS ESPIRITUALES
  { date: '2026-03-21', title: 'Día del Joven Adventista', type: 'Espiritual' },
  { date: '2026-03-28', title: 'Evangelismo Semana Santa', type: 'Espiritual' },
  { date: '2026-03-29', title: 'Evangelismo Semana Santa', type: 'Espiritual' },
  { date: '2026-03-30', title: 'Evangelismo Semana Santa', type: 'Espiritual' },
  { date: '2026-03-31', title: 'Evangelismo Semana Santa', type: 'Espiritual' },
  { date: '2026-04-01', title: 'Evangelismo Semana Santa', type: 'Espiritual' },
  { date: '2026-04-02', title: 'Evangelismo Semana Santa', type: 'Espiritual' },
  { date: '2026-04-03', title: 'Evangelismo Semana Santa', type: 'Espiritual' },
  { date: '2026-04-04', title: 'Evangelismo Semana Santa', type: 'Espiritual' },
  ...
  { date: '2026-10-24', title: '2º Semana de Oración / Sáb. Creación', type: 'Espiritual' },
  { date: '2026-11-21', title: 'Culto Acción de Gracias', type: 'Espiritual' },
...
export default function StudyPlanTracker() {
  ...
  if (isLoading) {
    return <div className={`min-h-screen flex items-center justify-center ${isDarkMode ? 'bg-slate-900 text-teal-400' : 'bg-slate-50 text-teal-600'} font-semibold text-xl animate-pulse`}>Cargando Comunidad...</div>;
  }

  if (!user) {
    return (
      <div className={`min-h-screen ${isDarkMode ? 'bg-slate-900' : 'bg-slate-50'} flex items-center justify-center p-4 transition-colors`}>
        <div className={`${isDarkMode ? 'bg-slate-800 border-teal-700' : 'bg-white border-teal-500'} p-8 rounded-2xl shadow-xl max-w-md w-full text-center border-t-4 transition-colors`}>
          ...
          <button onClick={handleLogin} className={`w-full ${isDarkMode ? 'bg-slate-700 border-slate-600 text-white hover:bg-slate-600 hover:border-teal-500' : 'bg-white border-slate-200 text-slate-700 hover:bg-slate-50 hover:border-teal-400'} border-2 font-bold py-3 px-4 rounded-xl transition-all flex items-center justify-center gap-3 shadow-sm`}>
  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'bg-slate-900 text-slate-200' : 'bg-slate-50 text-slate-800'} font-sans pb-12 transition-colors duration-300`}>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-3 w-full md:w-auto justify-between md:justify-start">
              ...
              <div className="flex items-center gap-2 md:hidden">
                <button onClick={() => setIsDarkMode(!isDarkMode)} className="p-2 text-teal-100 hover:text-white transition-colors">{isDarkMode ? <Sun size={20} /> : <Moon size={20} />}</button>
                <button onClick={handleLogout} className="p-2 text-teal-100 hover:text-white transition-colors" title="Cerrar sesión"><LogOut size={20} /></button>
              </div>
            </div>
            <div className="hidden md:flex items-center gap-4 w-full md:w-auto bg-black/10 backdrop-blur-md p-3 rounded-xl border border-white/10 shadow-inner">
              <div className="flex flex-col items-center justify-center pr-4 border-r border-white/20"><span className="text-[10px] text-teal-100 uppercase tracking-wider font-bold">Promedio</span><span className="text-xl font-black text-white">{gpaCalculation}</span></div>
              <div className="flex-1 w-56"><div className="flex justify-between text-xs mb-1.5 font-medium text-teal-50 uppercase tracking-wider"><span>Avance General</span><span>{progressPercentage}%</span></div><div className="w-full bg-black/20 rounded-full h-2.5 overflow-hidden border border-black/10"><div className="bg-gradient-to-r from-green-400 to-emerald-300 h-full rounded-full transition-all duration-500 ease-out shadow-[0_0_10px_rgba(52,211,153,0.5)]" style={{ width: `${progressPercentage}%` }}></div></div></div>
              <div className="flex items-center gap-1 pl-2 border-l border-white/20">
                <button onClick={() => setIsDarkMode(!isDarkMode)} className="p-2 bg-white/10 hover:bg-white/20 rounded-lg transition-colors text-white shadow-sm hover:shadow backdrop-blur-sm" title="Modo Oscuro">{isDarkMode ? <Sun size={18} /> : <Moon size={18} />}</button>
                <button onClick={handleLogout} className="p-2 bg-white/10 hover:bg-white/20 rounded-lg transition-colors text-white shadow-sm hover:shadow backdrop-blur-sm" title="Cerrar sesión"><LogOut size={18} /></button>
              </div>
            </div>
          </div>
...
function TabButton({ active, onClick, icon, label, isDarkMode }) {
  const bgActive = isDarkMode ? 'bg-slate-900 text-teal-400 border-t-4 border-teal-500' : 'bg-slate-50 text-teal-800 border-t-4 border-teal-500 shadow-md';
  const bgInactive = 'bg-white/10 text-teal-50 hover:bg-white/20 hover:text-white backdrop-blur-sm mb-1';
  ...
  return (
    <>
      <div className="flex flex-wrap justify-center gap-3 mb-10 text-xs md:text-sm">
        <div className={`flex items-center gap-2 px-3 py-1 rounded-full shadow-sm border ${cardBg}`}><div className="w-3 h-3 rounded-full bg-emerald-600"></div><span className={`font-bold ${textColor}`}>Promocionada</span></div>
        <div className={`flex items-center gap-2 px-3 py-1 rounded-full shadow-sm border ${cardBg}`}><div className="w-3 h-3 rounded-full bg-green-400"></div><span className={`font-bold ${textColor}`}>Aprobada</span></div>
        <div className={`flex items-center gap-2 px-3 py-1 rounded-full shadow-sm border ${cardBg}`}><div className="w-3 h-3 rounded-full bg-blue-500"></div><span className={`font-bold ${textColor}`}>Regular</span></div>
        <div className={`flex items-center gap-2 px-3 py-1 rounded-full shadow-sm border ${cardBg}`}><div className="w-3 h-3 rounded-full bg-yellow-400"></div><span className={`font-bold ${textColor}`}>Cursando</span></div>
        <div className={`flex items-center gap-2 px-3 py-1 rounded-full shadow-sm border ${cardBg}`}><div className="w-3 h-3 rounded-full bg-red-500"></div><span className={`font-bold ${textColor}`}>Pérdida/Libre</span></div>
        <div className={`flex items-center gap-2 px-3 py-1 rounded-full shadow-sm border border-teal-500 ring-2 ${isDarkMode ? 'ring-teal-900 bg-slate-800' : 'ring-teal-50 bg-white'}`}><div className={`w-3 h-3 rounded-full ${isDarkMode ? 'bg-slate-800' : 'bg-white'} border-2 border-teal-500`}></div><span className="font-bold text-teal-500">Disponible</span></div>
        <div className={`flex items-center gap-2 px-3 py-1 rounded-full shadow-sm border ${cardBg} opacity-70`}><div className="w-3 h-3 rounded-full bg-slate-500"></div><span className={`font-medium ${isDarkMode ? 'text-slate-400' : 'text-slate-500'}`}>Bloqueada</span></div>
      </div>

      <div className="space-y-16">
        {Object.entries(subjectsByGroup).map(([year, semesters]) => (
          <div key={year} className="relative">
            <div className="sticky top-28 z-0 flex items-center mb-6"><div className={`font-bold px-6 py-2 rounded-r-xl shadow-md -ml-4 text-lg border-l-4 border-teal-400 ${isDarkMode ? 'bg-slate-800 text-white' : 'bg-slate-800 text-white'}`}>{year}° Año</div><div className={`h-px flex-1 ml-4 ${isDarkMode ? 'bg-slate-700' : 'bg-slate-200'}`}></div></div>
...
function SubjectCard({ subject, status, detail, missingPrereqs, onToggle, isDarkMode }) {
  ...
  // Dark mode adjustments for card colors
  const lockedBg = isDarkMode ? 'bg-slate-800/40 border-slate-700' : 'bg-slate-50/50 border-slate-200 hover:bg-slate-100';
  const availableBg = isDarkMode ? 'bg-slate-800 border-teal-700 ring-2 ring-teal-900/50 hover:border-teal-500' : 'bg-white border-teal-300 ring-2 ring-teal-50 hover:ring-teal-100 hover:border-teal-400';
  const textTitle = isLocked ? (isDarkMode ? 'text-slate-500' : 'text-slate-400') : (isPromocion ? 'text-white' : (isDarkMode ? 'text-slate-200' : 'text-slate-800'));

  return (
    <div onClick={onToggle} className={`relative p-3 rounded-xl border transition-all duration-200 cursor-pointer select-none group flex flex-col h-full min-h-[100px] shadow-sm ${isLocked ? lockedBg : ''} ${isPromocion ? 'bg-emerald-600 border-emerald-700 text-white shadow-md' : ''} ${isAprobada ? 'bg-green-100 border-green-400 text-green-900' : ''} ${isRegular ? 'bg-blue-100 border-blue-400 text-blue-900' : ''} ${isCursando ? 'bg-yellow-100 border-yellow-400 text-yellow-900' : ''} ${isPerdida ? 'bg-red-100 border-red-400 text-red-900' : ''} ${isAvailable ? availableBg : ''} ${isAvailable && !isDarkMode ? 'hover:-translate-y-0.5 shadow-md' : ''}`}>
      <div className="flex justify-between items-start gap-2 mb-1">
        <h3 className={`font-semibold text-sm leading-snug ${textTitle}`}>{subject.name}</h3>
        <div className={`shrink-0 p-1 rounded-full transition-colors mt-0.5 ${isPromocion ? 'bg-white/20 text-white' : ''} ${isAprobada ? 'bg-green-500 text-white' : ''} ${isRegular ? 'bg-blue-500 text-white' : ''} ${isCursando ? 'bg-yellow-400 text-white' : ''} ${isPerdida ? 'bg-red-500 text-white' : ''} ${isAvailable ? (isDarkMode ? 'bg-teal-900/50 text-teal-400' : 'bg-teal-100 text-teal-600') : ''} ${isLocked ? (isDarkMode ? 'text-slate-600' : 'text-slate-300') : ''}`}>
      ...
      {isLocked && missingPrereqs && missingPrereqs.length > 0 && (
        <div className="mt-auto pt-2"><div className="flex items-center gap-1 text-[10px] uppercase font-bold text-red-400 mb-0.5"><AlertCircle size={10} /><span>Falta correlativa</span></div><p className={`text-[10px] leading-tight ${isDarkMode ? 'text-slate-500' : 'text-slate-500'}`}>{missingPrereqs[0]} {missingPrereqs.length > 1 && `+ ${missingPrereqs.length - 1} más`}</p></div>
      )}
    </div>
  );
}
...
function SubjectDetailsModal({ subject, currentDetails, onSave, onClose, isDarkMode }) {
  ...
  const bgModal = isDarkMode ? 'bg-slate-800' : 'bg-slate-50';
  const bgCard = isDarkMode ? 'bg-slate-900 border-slate-700' : 'bg-white border-slate-200';
  const textPrimary = isDarkMode ? 'text-slate-200' : 'text-slate-700';
  const inputBg = isDarkMode ? 'bg-slate-800 border-slate-600 text-white placeholder-slate-500' : 'bg-slate-50 border-slate-300 text-slate-900';
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className={`rounded-2xl shadow-2xl w-full max-w-xl overflow-hidden flex flex-col max-h-[90vh] ${bgModal}`}>
        ...
        <div className={`p-6 overflow-y-auto ${bgModal}`}>
          <form id="subject-form" onSubmit={(e) => { e.preventDefault(); onSave(formData); }} className="space-y-6">
            <div className={`p-5 rounded-xl border shadow-sm ${bgCard}`}>
              <h3 className="text-xs font-bold text-teal-500 uppercase tracking-wider mb-3 border-b border-slate-700 pb-2">Progreso Académico</h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                {formData.status === 'final' && (<div><label className="block text-sm font-bold text-blue-500 mb-1">Nota Definitiva (Final)</label><input type="number" min="1" max="10" className={`w-full px-3 py-2 border-2 border-blue-500/50 rounded-lg focus:ring-2 focus:ring-blue-500 font-bold outline-none ${isDarkMode ? 'bg-blue-900/20 text-white' : 'bg-blue-50 text-slate-900'}`} value={formData.gradeFinal} onChange={e => setFormData({...formData, gradeFinal: e.target.value})} /></div>)}
                {(formData.status === 'promocion' || formData.status === 'aprobada') && (<div className="sm:col-span-2"><label className="block text-sm font-bold text-blue-500 mb-1">Nota Definitiva (Promoción)</label><input type="number" min="1" max="10" className={`w-full px-3 py-2 border-2 border-blue-500/50 rounded-lg focus:ring-2 focus:ring-blue-500 font-bold outline-none ${isDarkMode ? 'bg-blue-900/20 text-white' : 'bg-blue-50 text-slate-900'}`} value={formData.gradePromocion} onChange={e => setFormData({...formData, gradePromocion: e.target.value})} /></div>)}
              </div>
            </div>
            <div className={`p-5 rounded-xl border shadow-sm ${bgCard}`}>
              <h3 className="text-xs font-bold text-teal-500 uppercase tracking-wider mb-3 border-b border-slate-700 pb-2">Información del Profesor y Cursada</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className={`p-4 border-t flex justify-end gap-3 shrink-0 ${isDarkMode ? 'bg-slate-900 border-slate-700' : 'bg-white border-slate-200'}`}><button onClick={onClose} className={`px-5 py-2 font-medium rounded-lg transition-colors ${isDarkMode ? 'text-slate-400 hover:bg-slate-800' : 'text-slate-600 hover:bg-slate-100'}`}>Cancelar</button><button type="submit" form="subject-form" className="px-6 py-2 bg-teal-600 text-white font-bold rounded-lg hover:bg-teal-700 transition-colors flex items-center gap-2"><Save size={18}/> Guardar Ficha</button></div>
      </div>
    </div>
  );
}
...
function VaultView({ user, vaultItems, subjects, isDarkMode }) {
  ...
  const bgCard = isDarkMode ? 'bg-slate-800 border-slate-700 text-white' : 'bg-white border-slate-200 text-slate-800';
  const inputBg = isDarkMode ? 'bg-slate-900 border-slate-700 text-white placeholder-slate-500' : 'border-slate-300 bg-white text-slate-900';
  ...
  return (
    <div className="max-w-4xl mx-auto"><div className="flex justify-between items-center mb-6"><div><h2 className={`text-2xl font-bold ${isDarkMode ? 'text-white' : 'text-slate-800'}`}>Bóveda de Apuntes</h2><p className={`text-sm ${isDarkMode ? 'text-slate-400' : 'text-slate-500'}`}>Comparte resúmenes y parciales viejos.</p></div><button onClick={() => setShowForm(!showForm)} className="bg-teal-600 text-white px-4 py-2 rounded-lg hover:bg-teal-700 transition-colors"><Plus size={18} className="inline mr-2"/>Compartir</button></div>
      {showForm && (
        <form onSubmit={handleAdd} className={`p-5 rounded-xl border border-teal-500/50 mb-8 grid grid-cols-2 gap-4 shadow-sm ${bgCard}`}>
          ...
          <button type="submit" className="col-span-2 bg-teal-600 text-white font-bold py-2 rounded-lg hover:bg-teal-700 transition-colors">Publicar</button>
        </form>
      )}
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
        {vaultItems.map(item => (
          <div key={item.id} className={`p-4 rounded-xl border hover:shadow-md transition-shadow relative flex flex-col ${bgCard}`}>
            <span className={`text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded w-fit ${isDarkMode ? 'bg-teal-900/50 text-teal-400' : 'bg-teal-50 text-teal-700'}`}>{subjects.find(s=>s.id===item.subjectId)?.name || 'General'}</span>
            {user.uid === item.authorId && <button onClick={() => deleteDoc(doc(db, 'artifacts', appId, 'public', 'data', 'vault', item.id))} className="absolute top-4 right-4 text-slate-400 hover:text-red-500"><Trash2 size={16}/></button>}
            <h3 className="font-semibold mt-2 mb-4 line-clamp-2">{item.title}</h3>
            <div className="mt-auto">
              <a href={item.link} target="_blank" rel="noreferrer" className={`flex items-center justify-center gap-2 w-full font-medium py-2 rounded-lg border transition-colors ${isDarkMode ? 'bg-slate-700 border-slate-600 text-teal-400 hover:bg-slate-600' : 'bg-slate-50 text-teal-700 hover:bg-teal-50 hover:border-teal-200'}`}>Abrir Enlace <ExternalLink size={14}/></a>
            </div>
          </div>
        ))}
        {vaultItems.length === 0 && <div className={`col-span-3 text-center py-12 rounded-xl border border-dashed ${isDarkMode ? 'bg-slate-800 border-slate-700 text-slate-400' : 'bg-white border-slate-300 text-slate-500'}`}>No hay apuntes compartidos aún.</div>}
      </div>
    </div>
  );
}
...
function CalendarView({ user, calendarEvents, subjects, subjectDetails, isDarkMode }) {
  ...
  const inputBg = isDarkMode ? 'bg-slate-900 border-slate-700 text-white' : 'bg-white border-slate-300 text-slate-900';
  ...
  return (
    <div className="max-w-5xl mx-auto animate-in fade-in duration-500">
      ...
      <div className={`rounded-2xl shadow-sm border overflow-hidden mb-8 ${bgCard}`}>
        ...
        <div className={`grid grid-cols-7 text-center py-3 border-b font-bold text-sm ${isDarkMode ? 'bg-slate-900 border-slate-700 text-slate-400' : 'bg-slate-100 border-slate-200 text-slate-500'}`}>
            ...
            return (
              <div 
                ...
                className={`min-h-[80px] sm:min-h-[100px] p-1 sm:p-2 border rounded-xl cursor-pointer transition-all flex flex-col items-center hover:shadow-md
                  ${isSelected ? (isDarkMode ? 'border-teal-500 ring-2 ring-teal-800 bg-slate-800' : 'border-teal-500 ring-2 ring-teal-200 bg-teal-50 shadow-sm') : (isDarkMode ? 'border-slate-800 bg-slate-800 hover:border-teal-700' : 'border-slate-100 hover:border-teal-300 bg-white')}
                  ${uapEvents.some(e=>e.type==='Receso') ? (isDarkMode ? 'bg-slate-800/50 border-dashed' : 'bg-slate-50 border-dashed') : ''}`}
              >
        ...
        <div className={`border-t p-4 sm:p-6 ${isDarkMode ? 'bg-slate-900 border-slate-700' : 'bg-slate-50 border-slate-200'}`}>
          ...
          <div className={`flex flex-wrap gap-x-6 gap-y-3 text-xs sm:text-sm mb-4 pb-4 border-b ${isDarkMode ? 'border-slate-800' : 'border-slate-200'}`}>
            <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-amber-700"></div><span className={`font-medium ${isDarkMode ? 'text-slate-300' : 'text-slate-700'}`}>Feriados</span></div>
            <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-yellow-500"></div><span className={`font-medium ${isDarkMode ? 'text-slate-300' : 'text-slate-700'}`}>Énfasis Espiritual</span></div>
            <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-sky-400"></div><span className={`font-medium ${isDarkMode ? 'text-slate-300' : 'text-slate-700'}`}>Recesos</span></div>
            <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-red-500"></div><span className={`font-medium ${isDarkMode ? 'text-slate-300' : 'text-slate-700'}`}>Exámenes UAP</span></div>
            <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-indigo-600"></div><span className={`font-medium ${isDarkMode ? 'text-slate-300' : 'text-slate-700'}`}>Institucional</span></div>
            <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-slate-500"></div><span className={`font-medium ${isDarkMode ? 'text-slate-300' : 'text-slate-700'}`}>Trámites / Admin</span></div>
          </div>
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-3 text-xs sm:text-sm">
            <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-orange-500"></div><span className={`font-medium ${isDarkMode ? 'text-slate-300' : 'text-slate-700'}`}>Mis Exámenes</span></div>
            <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-purple-500"></div><span className={`font-medium ${isDarkMode ? 'text-slate-300' : 'text-slate-700'}`}>Exposiciones</span></div>
            <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-blue-400"></div><span className={`font-medium ${isDarkMode ? 'text-slate-300' : 'text-slate-700'}`}>Entregas (TP)</span></div>
            <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-pink-500"></div><span className={`font-medium ${isDarkMode ? 'text-slate-300' : 'text-slate-700'}`}>Cumpleaños / Especial</span></div>
          </div>
        </div>
      </div>
        ...
        {selectedDateStr ? (
          <div>
            <div className={`flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6 pb-4 border-b ${isDarkMode ? 'border-slate-700' : 'border-slate-100'}`}>
              ...
              <button onClick={() => setShowForm(!showForm)} className={`px-4 py-2 rounded-lg font-bold flex items-center gap-2 transition-colors ${showForm ? (isDarkMode ? 'bg-slate-700 text-slate-300' : 'bg-slate-200 text-slate-700') : 'bg-teal-600 text-white hover:bg-teal-700 shadow-sm'}`}>
            ...
            {showForm && (
              <form onSubmit={handleAdd} className={`p-5 rounded-xl border mb-8 grid grid-cols-1 sm:grid-cols-2 gap-4 ${isDarkMode ? 'bg-slate-900 border-slate-700' : 'bg-teal-50/50 border-teal-100'}`}>
                ...
                {formData.type !== 'Especial' ? (
                  ...
                  <div className="flex items-center"><span className="text-sm font-medium text-pink-600 bg-pink-100 px-3 py-2.5 rounded-lg w-full flex items-center gap-2"><Gift size={18}/> Visible para toda la comunidad</span></div>
                )}
                  ...
                  <div key={ev.id} className={`border p-4 rounded-xl flex items-center justify-between gap-4 group ${colorClasses}`}>
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        {!isEspecial && <p className="text-sm text-slate-500 mt-0.5">{subjects.find(s=>s.id===ev.subjectId)?.name}</p>}
                      </div>
                    </div>
                    {isOwner && (
          ...
          <div className="flex flex-col items-center justify-center h-full text-center py-20">
            <div className={`p-6 rounded-full mb-4 ${isDarkMode ? 'bg-slate-900' : 'bg-teal-50'}`}>
...
function ScheduleView({ user, scheduleItems, availabilityItems, subjects, subjectDetails, isDarkMode }) {
  ...
  const bgCard = isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-slate-200';
  const textPrimary = isDarkMode ? 'text-white' : 'text-slate-800';
  const inputBg = isDarkMode ? 'bg-slate-900 border-slate-700 text-white placeholder-slate-500' : 'bg-white border-slate-300 text-slate-900';

  return (
    <div className="max-w-6xl mx-auto animate-in fade-in duration-500">
      <div className="flex justify-center mb-8">
        <div className={`p-1 rounded-xl inline-flex shadow-inner ${isDarkMode ? 'bg-slate-800' : 'bg-slate-200'}`}>
          <button onClick={() => { setSubTab('classes'); setShowForm(false); }} className={`flex items-center gap-2 px-5 py-2.5 rounded-lg font-medium text-sm transition-all ${subTab === 'classes' ? (isDarkMode ? 'bg-slate-700 text-teal-400 shadow' : 'bg-white text-teal-700 shadow') : (isDarkMode ? 'text-slate-400 hover:text-slate-200' : 'text-slate-600 hover:text-slate-800')}`}><Clock size={16} /> Mis Horarios</button>
          <button onClick={() => { setSubTab('availability'); setShowForm(false); }} className={`flex items-center gap-2 px-5 py-2.5 rounded-lg font-medium text-sm transition-all ${subTab === 'availability' ? (isDarkMode ? 'bg-slate-700 text-green-400 shadow' : 'bg-white text-green-700 shadow') : (isDarkMode ? 'text-slate-400 hover:text-slate-200' : 'text-slate-600 hover:text-slate-800')}`}><Users size={16} /> Grupos de TP</button>
        </div>
      </div>
      ...
      {showForm && subTab === 'classes' && (
        <form onSubmit={handleAddSchedule} className={`p-5 rounded-xl shadow-md border mb-8 border-t-4 border-t-teal-500 ${bgCard}`}>
          ...
          <button type="submit" className="w-full bg-teal-600 text-white hover:bg-teal-700 font-bold py-2 rounded-lg transition-colors">Cargar Clase al Sistema</button>
        </form>
      )}
      ...
      {showForm && subTab === 'availability' && (
        <form onSubmit={handleAddAvailability} className={`p-5 rounded-xl shadow-md border mb-8 border-t-4 border-t-green-500 ${bgCard}`}>
          ...
          <button type="submit" className="w-full bg-green-600 text-white hover:bg-green-700 font-bold py-2 rounded-lg transition-colors">Publicar mi Disponibilidad</button>
        </form>
      )}
        ...
        {DAYS.map(day => {
          ...
          return (
            <div key={day} className={`rounded-xl shadow-sm border overflow-hidden flex flex-col min-h-[150px] ${bgCard}`}>
              <div className={`py-2 text-center border-b ${subTab === 'classes' ? (isDarkMode ? 'bg-slate-900 border-slate-700' : 'bg-slate-100 border-slate-200') : (isDarkMode ? 'bg-green-900/20 border-green-900/50' : 'bg-green-50 border-green-200')}`}><h3 className={`font-bold uppercase text-sm tracking-wider ${subTab === 'classes' ? (isDarkMode ? 'text-slate-300' : 'text-slate-700') : (isDarkMode ? 'text-green-500' : 'text-green-800')}`}>{day}</h3></div>
              <div className={`p-3 flex-1 space-y-3 ${isDarkMode ? 'bg-slate-800/50' : 'bg-slate-50/50'}`}>
                {dayItems.length === 0 ? <p className="text-center text-xs text-slate-500 py-4 italic">Libre</p> : dayItems.map(item => {
                  const isOwner = user?.uid === item.authorId;
                  if (subTab === 'classes') {
                    const subject = subjects.find(s => s.id === item.subjectId);
                    return (
                      <div key={item.id} className={`p-3 rounded-lg shadow-sm border relative group ${isDarkMode ? 'bg-slate-800 border-teal-900/50' : 'bg-white border-teal-100'}`}>
                        {isOwner && <button onClick={() => handleDelete(item.id, item.authorId, 'schedule')} className={`absolute top-2 right-2 hover:text-red-500 ${isDarkMode ? 'text-slate-500' : 'text-slate-300'}`}><Trash2 size={14} /></button>}
                        <div className="text-xs font-bold text-teal-500 mb-1 flex items-center gap-1"><Clock size={12} /> {item.startTime} - {item.endTime}</div>
                    ...
                    return (
                      <div key={item.id} className={`p-3 rounded-lg shadow-sm border relative group ${isDarkMode ? 'bg-slate-800 border-green-900/50' : 'bg-white border-green-200'}`}>
                        {isOwner && <button onClick={() => handleDelete(item.id, item.authorId, 'availability')} className={`absolute top-2 right-2 hover:text-red-500 ${isDarkMode ? 'text-slate-500' : 'text-slate-300'}`}><Trash2 size={14} /></button>}
                        <div className="text-xs font-bold text-green-500 mb-1 flex items-center gap-1"><Clock size={12} /> {item.startTime} - {item.endTime}</div>
                        <h4 className={`text-sm font-semibold flex items-center gap-1 ${textPrimary}`}><Users size={14} className="text-slate-400"/> {item.userName}</h4>
...
function ChatView({ user, chatMessages, subjectDetails, subjects, isDarkMode }) {
  ...
  if (cursandoSubjects.length === 0) {
    return (
      <div className={`max-w-3xl mx-auto h-[600px] flex flex-col items-center justify-center rounded-2xl shadow-sm border p-8 text-center ${bgCard}`}>
        <Users size={64} className={isDarkMode ? 'text-slate-600 mb-4' : 'text-slate-300 mb-4'} />
  ...
  return (
    <div className={`max-w-5xl mx-auto h-[600px] flex rounded-2xl shadow-sm border overflow-hidden ${bgCard}`}>
      <div className={`w-1/3 sm:w-1/4 border-r flex flex-col ${isDarkMode ? 'bg-slate-900 border-slate-700' : 'bg-slate-50 border-slate-200'}`}>
        ...
        <div className="flex-1 overflow-y-auto p-2 space-y-1">
          {cursandoSubjects.map(sub => (
            <button key={sub.id} onClick={() => setActiveRoom(sub.id)} className={`w-full text-left p-3 rounded-lg text-sm font-medium transition-colors ${activeRoom === sub.id ? (isDarkMode ? 'bg-teal-900/50 text-teal-400 border border-teal-800' : 'bg-teal-100 text-teal-800 shadow-sm border border-teal-200') : (isDarkMode ? 'text-slate-400 hover:bg-slate-800 border border-transparent' : 'text-slate-600 hover:bg-slate-200 border border-transparent')}`}>
              <div className="line-clamp-2 leading-tight">{sub.name}</div>
            </button>
          ))}
        </div>
      </div>
      <div className={`w-2/3 sm:w-3/4 flex flex-col ${isDarkMode ? 'bg-slate-800' : 'bg-white'}`}>
        ...
        <div className={`flex-1 overflow-y-auto p-4 flex flex-col gap-3 ${isDarkMode ? 'bg-slate-900' : 'bg-slate-50/50'}`}>
          {currentMessages.length === 0 && <div className={`text-center mt-20 ${isDarkMode ? 'text-slate-500' : 'text-slate-400'}`}>No hay mensajes en esta materia aún. ¡Rompe el hielo y di hola!</div>}
          {currentMessages.map(m => {
            ...
            return (
              <div key={m.id} className={`flex flex-col max-w-[85%] ${isMe ? 'self-end items-end' : 'self-start items-start'}`}>
                <span className="text-[10px] text-slate-500 mb-0.5 px-1 font-medium">{m.authorName}</span>
                <div className={`px-4 py-2 rounded-2xl ${isMe ? 'bg-teal-600 text-white rounded-tr-none' : (isDarkMode ? 'bg-slate-700 border border-slate-600 text-slate-200 rounded-tl-none' : 'bg-white border shadow-sm rounded-tl-none text-slate-700')}`}>{m.text}</div>
              </div>
            );
          })}
          <div ref={messagesEndRef} />
        </div>
        <form onSubmit={handleSend} className={`p-3 border-t flex gap-2 ${isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-slate-200'}`}>
          <input type="text" value={msg} onChange={e => setMsg(e.target.value)} placeholder="Escribe un mensaje al grupo..." className={`flex-1 border rounded-full px-4 py-2 outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent ${isDarkMode ? 'bg-slate-900 border-slate-600 text-white placeholder-slate-500' : 'border-slate-300'}`} />
          <button type="submit" className="bg-teal-600 hover:bg-teal-700 text-white p-3 rounded-full transition-colors"><Send size={18}/></button>
        </form>
      </div>
    </div>
  );
...
function PomodoroTimer({ isDarkMode }) {
  ...
  return (
    <div className={`p-6 rounded-2xl border shadow-sm mb-8 text-center max-w-sm mx-auto ${isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-slate-200'}`}>
      ...
      <div className="flex justify-center gap-2 mb-6">
        <button onClick={() => changeMode('study')} className={`px-4 py-1.5 rounded-full font-bold text-sm transition-colors ${mode === 'study' ? 'bg-teal-500 text-white' : isDarkMode ? 'bg-slate-700 text-slate-400 hover:bg-slate-600' : 'bg-slate-100 text-slate-500 hover:bg-slate-200'}`}>
          <Brain size={14} className="inline mr-1"/> Estudio
        </button>
        <button onClick={() => changeMode('break')} className={`px-4 py-1.5 rounded-full font-bold text-sm transition-colors ${mode === 'break' ? 'bg-emerald-500 text-white' : isDarkMode ? 'bg-slate-700 text-slate-400 hover:bg-slate-600' : 'bg-slate-100 text-slate-500 hover:bg-slate-200'}`}>
      ...
      <div className="flex justify-center gap-4">
        <button onClick={toggleTimer} className="w-14 h-14 rounded-full bg-teal-500 text-white flex items-center justify-center hover:bg-teal-600 shadow-md transition-colors">
          {isActive ? <Pause fill="currentColor" size={24}/> : <Play fill="currentColor" size={24} className="ml-1"/>}
        </button>
        <button onClick={resetTimer} className={`w-14 h-14 rounded-full flex items-center justify-center border shadow-sm transition-colors ${isDarkMode ? 'border-slate-600 bg-slate-700 text-slate-300 hover:bg-slate-600' : 'border-slate-200 bg-white text-slate-600 hover:bg-slate-50'}`} title="Reiniciar">
          <RotateCcw size={20}/>
        </button>
      </div>
    </div>
...
function FocusView({ user, activeStream, setActiveStream, customStreams, isDarkMode }) {
  ...
  return (
    <div className="max-w-4xl mx-auto text-center animate-in fade-in duration-500">
      ...
      {showForm && (
        <form onSubmit={handleAddStream} className={`p-5 rounded-xl border mb-8 grid grid-cols-1 md:grid-cols-2 gap-4 shadow-md max-w-2xl mx-auto text-left ${isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-teal-200'}`}>
          <div><label className={`block text-sm font-medium mb-1 ${isDarkMode ? 'text-slate-200' : 'text-slate-700'}`}>Nombre de la Playlist</label><input required placeholder="Ej: Rock instrumental" className={`w-full border p-2.5 rounded-lg focus:ring-2 focus:ring-teal-500 outline-none ${inputBg}`} value={streamData.title} onChange={e => setStreamData({...streamData, title: e.target.value})} /></div>
          <div><label className={`block text-sm font-medium mb-1 ${isDarkMode ? 'text-slate-200' : 'text-slate-700'}`}>Enlace de YouTube</label><input required placeholder="https://www.youtube.com/watch?v=..." className={`w-full border p-2.5 rounded-lg focus:ring-2 focus:ring-teal-500 outline-none ${inputBg}`} value={streamData.url} onChange={e => setStreamData({...streamData, url: e.target.value})} /></div>
          <button type="submit" className={`md:col-span-2 font-bold py-2.5 rounded-lg transition-colors ${isDarkMode ? 'bg-teal-900/50 text-teal-400 hover:bg-teal-900/80 border border-teal-800' : 'bg-teal-50 text-teal-700 hover:bg-teal-100 border border-teal-100'}`}>Compartir con la comunidad</button>
        </form>
      )}
        ...
        {[...STREAMS, ...customStreams].map(stream => {
          ...
          return (
            <div key={stream.id} className="relative group">
              ...
              <button onClick={() => setActiveStream(stream)} className={`w-full h-full p-4 rounded-xl border-2 text-left transition-all flex flex-col ${isActive ? (isDarkMode ? 'border-teal-500 bg-teal-900/30' : 'border-teal-500 bg-teal-50 shadow-md ring-2 ring-teal-100') : (isDarkMode ? 'bg-slate-800 border-slate-700 hover:border-teal-600' : 'bg-white hover:border-teal-300 hover:shadow-sm border-slate-200')}`}>
                <div className="flex justify-between w-full items-start mb-2"><span className={`text-[10px] px-2 py-0.5 rounded font-bold uppercase tracking-wide border ${stream.color}`}>{stream.category}</span><PlayCircle className={isActive ? 'text-teal-500' : (isDarkMode ? 'text-slate-500' : 'text-slate-300')} size={18} /></div>
                <h4 className={`font-bold leading-tight mb-1 ${isDarkMode ? 'text-white' : 'text-slate-800'}`}>{stream.title}</h4>
                <p className={`text-[11px] line-clamp-1 ${isDarkMode ? 'text-slate-400' : 'text-slate-500'}`}>{stream.desc}</p>
              </button>
            </div>
          );
        })}
